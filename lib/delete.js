...
exports.deleteDept = () => {
    view.viewAllDeptCB(function (allDeptRes) {
        ...
        inquirer.prompt([
            ...
            .then(function (res) {
                connection.query('DELETE FROM department WHERE dept_name = ?', [res.department.dept_name], function (err, res) {
                    if (err) throw err;
...
exports.deleteRole = () => {
    view.viewAllRolesCB(function (allRoleRes) {
        ...
        inquirer.prompt([
            ...
            .then(function (res) {
                connection.query('DELETE FROM acting_role WHERE title = ?', [res.title], function (err, res) {
                    if (err) throw err;
                    console.log("The department has been successfully deleted!");
                    app.start();
                });
